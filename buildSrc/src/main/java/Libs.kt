...
object Libs {
    ...
    const val LIFECYCLE_COMMON = "androidx.lifecycle:lifecycle-common-java8"
    ...
    const val CONNECTYCUBE_CHAT = "com.connectycube:connectycube-android-sdk-chat"
    const val CONNECTYCUBE_VIDEOCHAT = "com.connectycube:connectycube-android-sdk-videochat"
    const val CONNECTYCUBE_STORAGE = "com.connectycube:connectycube-android-sdk-storage"
    const val CONNECTYCUBE_PUSHNOTIFICATIONS = "com.connectycube:connectycube-android-sdk-pushnotifications"

    const val KODEIN = "org.kodein.di:kodein-di-generic-jvm"
    const val KODEIN_ANDROID = "org.kodein.di:kodein-di-framework-android-x"

    const val COROUTINES_PLAY_EXT = "org.jetbrains.kotlinx:kotlinx-coroutines-play-services"
