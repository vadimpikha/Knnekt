 ...
 */
abstract class MyAbstractAppBarOnDestinationChangedListener
    ...
    MyAbstractAppBarOnDestinationChangedListener(@NonNull Context context,
                                                 @NonNull AppBarConfiguration configuration,
                                                 @NonNull TransitionResolver transitionResolver) {
        mContext = context;
    ...
    protected abstract void setNavigationIcon(Drawable icon, @StringRes int contentDescription, boolean useTransition);
    ...
    public void onDestinationChanged(@NonNull NavController controller,
        ...
        boolean useTransition = transitionResolver.isUseTransitionFor(destination);
        if (drawerLayout == null && isTopLevelDestination) {
            setNavigationIcon(null, 0, useTransition);
        } else {
            setActionBarUpIndicator(drawerLayout != null && isTopLevelDestination, useTransition);
        }
    }

    private void setActionBarUpIndicator(boolean showAsDrawerIndicator, boolean useTransition) {
        ...
        setNavigationIcon(mArrowDrawable, showAsDrawerIndicator
                ...
                : R.string.nav_app_bar_navigate_up_description, useTransition);
