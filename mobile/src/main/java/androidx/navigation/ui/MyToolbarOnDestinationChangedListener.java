 ...
 */
public class MyToolbarOnDestinationChangedListener extends
        MyAbstractAppBarOnDestinationChangedListener {
    private final WeakReference<Toolbar> mToolbarWeakReference;

    public MyToolbarOnDestinationChangedListener(
            @NonNull Toolbar toolbar, @NonNull AppBarConfiguration configuration,
            @NonNull TransitionResolver transitionResolver) {
        super(toolbar.getContext(), configuration, transitionResolver);
    ...
    protected void setNavigationIcon(Drawable icon,
                                     @StringRes int contentDescription, boolean useTransition) {
        Toolbar toolbar = mToolbarWeakReference.get();
        if (toolbar != null) {
