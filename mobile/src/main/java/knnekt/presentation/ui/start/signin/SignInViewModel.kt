...
import knnekt.shared.result.onError
import knnekt.shared.result.onSuccess
import knnekt.shared.result.throwOnError
...
class SignInViewModel(
    ...
    fun signIn() {
        ...
        viewModelScope.launch {
            signInUseCase(ConnectycubeSignInUseCase.Credentials(login, password))
                .onError (::onError)
                .onSuccess {
